    ...
    <footer className="bg-secondary/50 pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button 
                  onClick={() => openModal('Cookie Policy', cookiesContent)}
                  className="text-muted-foreground hover:text-foreground transition-colors text-left"
                >
                  Cookies
                </button>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div 
            className="bg-card rounded-2xl w-full max-w-2xl relative z-10 animate-fade-in shadow-xl max-h-[80vh] overflow-y-auto"
